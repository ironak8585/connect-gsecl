@php
    ...
    $fields = [
        ...
        'empdesig' => ['text', 'Designation'],
        'emplocation' => ['select', 'Location', $locations],
        'phone' => ['text', 'Phone'],
        'email' => ['text', 'Email'],
    ]
@endphp
            ...
            <tbody>
                @foreach ($records as $record)
                    <tr>
                        ...
                        <td>{{ $record->empdesig}}</td>
                        <td>{{ $record->empdepartment}}</td>
                        <td>{{ $record->emplocation}}</td>
                        <td>
                            <a href="{{ route("admin.eurja-employees.show", $record) }}" class="btn btn-sm btn-info"
